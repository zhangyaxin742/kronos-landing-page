    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center px-6 pb-16 text-center">
        ...
        <p className="mt-6 max-w-2xl text-pretty text-lg text-[color:var(--color-gray-700)] sm:text-xl">
          Premium timeblocking for those who demand precision and beauty.
        </p>
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-2 text-xs font-medium text-[color:var(--color-gray-700)]">
          <span className="rounded-full bg-[color:var(--accent-blue)] px-3 py-1">Deep Work</span>
          <span className="rounded-full bg-[color:var(--accent-green)] px-3 py-1">Team Sync</span>
          <span className="rounded-full bg-[color:var(--accent-purple)] px-3 py-1">Strategy</span>
          <span className="rounded-full bg-[color:var(--accent-yellow)] px-3 py-1">Review</span>
          <span className="rounded-full bg-[color:var(--accent-orange)] px-3 py-1">Focus Break</span>
          <span className="rounded-full bg-[color:var(--accent-red)] px-3 py-1">Wrap Up</span>
        </div>
        <div className="float-panel mt-12 w-full max-w-5xl rounded-[24px] border border-[color:var(--color-gray-200)] bg-[color:var(--color-white-90)] p-4 shadow-[var(--shadow-strong)] backdrop-blur">
          <Image
            ...
            alt="KRONOS dashboard preview showing color-coded timeblocks and a clean calendar layout."
            width={1200}
            height={720}
